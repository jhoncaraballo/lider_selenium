...
#def driver(request):
#    print("Iniciando Chrome sin detección (undetected-chromedriver)...")
#    
...
#    
#    # ¡ELIMINA excludeSwitches y useAutomationExtension!
#    # undetected-chromedriver ya los maneja internamente
#    
#    # Opcional: User agent real
...
#
#    # ¡SIN version_main! → Detecta Chrome automáticamente
